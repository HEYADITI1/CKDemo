...
## Ques.10: Reset the current user password and reboot the system from shell
...
## Ques.11: Zip the content of your home directory via tar and send it via scp to another laptop. Unzip it there via tar

```bash
tar -czvf linux_backup.tar.gz ~/linux_practical/

scp ~/linux_practical/linux_backup.tar.gz akanchha-singh@10.1.210.149:/home/akanchha-singh/aditi/

# On the remote system
tar -xzvf home_backup.tar.gz -C ~  # verify by extracting zipped file
```

---

## Ques.12: Install and setup applications via apt - MySQL, Postman, Docker, DBeaver
